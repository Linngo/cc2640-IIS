/** \mainpage Driver Overview
  ...
  * - <b>Project file</b>:     C:/Users/nyear/Documents/Texas Instruments/Sensor Controller Studio/examples/uarttest/uart_emulator_launchpad.scp
  * - <b>Code prefix</b>:      -
  ...
  * - <b>Created</b>:          2018-04-18 09:50:08.669
  * - <b>Computer</b>:         NYEAR-PC
  * - <b>User</b>:             nyear
  *
...
#define SCIF_UART_EMULATOR_DIO_UART_TX 30
...
typedef struct {
    uint16_t pTxBuffer[20]; ///< TX FIFO ring buffer
} SCIF_UART_EMULATOR_INPUT_T;


/// UART Emulator: Task output data structure
typedef struct {
    uint16_t pRxBuffer[200]; ///< RX FIFO ring buffer
...
#define SCIF_UART_TX_FIFO_MAX_COUNT                  19
/// Maximum number of characters that can be stored in the UART RX FIFO
#define SCIF_UART_RX_FIFO_MAX_COUNT                  199
